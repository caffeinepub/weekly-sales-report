...
export class Backend implements backendInterface {
    ...
    async addEntry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string, arg8: string, arg9: number, arg10: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getEntries(): Promise<Array<SalesEntry>> {
        if (this.processError) {
            try {
    ...
    async getEntriesByLeadSource(arg0: string): Promise<Array<SalesEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEntriesByLeadSource(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEntriesByStatusGroup(arg0: string): Promise<Array<SalesEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEntriesByStatusGroup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEntry(arg0: bigint): Promise<SalesEntry> {
        if (this.processError) {
            try {
    ...
    async updateEntry(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string, arg8: string, arg9: string, arg10: number, arg11: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateEntry(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
